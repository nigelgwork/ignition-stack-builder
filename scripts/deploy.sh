...
# Always rebuild images locally from latest code (no cache)
echo -e "${YELLOW}Rebuilding images from latest code (no cache)...${NC}"
docker compose build --no-cache backend frontend
echo -e "${GREEN}✓ Images rebuilt from latest code${NC}"
echo ""
