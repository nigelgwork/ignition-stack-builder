...
Print-Info "  4. Run 'docker compose version' to verify Docker Compose v2"
Print-Info ""
Print-Info "Important: Docker Compose v2 uses 'docker compose' (with a space)"
Print-Info "  ✓ Correct:   docker compose up -d"
Print-Info "  ✗ Old v1:    docker-compose up -d"
Print-Info ""
